                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            //循环
                            ExampaperEntity exampaperEntity = new ExampaperEntity();
//                            exampaperEntity.setExampaperName(data.get(0));                    //测评名称 要改的
//                            exampaperEntity.setExampaperDate(Integer.valueOf(data.get(0)));   //测试时长(分钟) 要改的
//                            exampaperEntity.setExampaperMyscore(Integer.valueOf(data.get(0)));   //测试总分数 要改的
//                            exampaperEntity.setExampaperTypes(Integer.valueOf(data.get(0)));   //测评状态 要改的
